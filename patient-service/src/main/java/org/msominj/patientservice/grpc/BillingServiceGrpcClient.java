package org.msominj.patientservice.grpc;
...
public class BillingServiceGrpcClient {
    ...
    //localhost:9001/BillingService/CreatePatientAccount for DEV
    //aws.grpc:port/BillingService/CreatePatientAccount for PROD
    public BillingServiceGrpcClient(
            @Value("${billing.service.address:localhost}") String serverAddress,
            @Value("${billing.service.port:9001}")  int serverPort) {

        log.info("Coonecting to BillingS ervice Grpc  service at {}:{}", serverAddress, serverPort);
